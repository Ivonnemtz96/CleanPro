    ...
    <div class="page-header-mobile-info">
        <div class="page-header-mobile-info-content">
            <div class="page-header-info">
                <i class="icon icon-location"></i>San José del Cabo, BCS
            </div>
            <div class="page-header-info">
                <i class="icon icon-clock1"></i>9:00 am - 5:00 pm
            </div>
            <div class="page-header-info">
            ...
            <div class="page-header-info">
                ...
                <a href="mailto:info@cleanpro.com">info@cleanpro.com</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="page-header-topline-right">
                ...
                <div class="quote-button-wrap">
                    <a href="contact.php" class="btn <?php echo $contacto?>"><i class="icon icon-bell"></i>Contactar</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="page-header-menu">
                <div class="container">
                    <ul class="menu">
                        ...
                        <li><a href="index.php#about">Nosotros</a>
                            <!-- <ul class="sub-menu">
                        ...
                        <li class="<?php echo $servicios?>"><a href="services.php">Servicios</a>
                            <!-- <ul class="sub-menu">
                        ...
                        <li class="<?php echo $galeria?>"><a href="gallery.php">Galería</a></li>
                        <li class="<?php echo $faqs?>"><a href="faqs.php">FAQs</a></li>
